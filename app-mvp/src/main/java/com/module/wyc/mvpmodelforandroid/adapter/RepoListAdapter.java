package com.module.wyc.mvpmodelforandroid.adapter;
...
import com.module.wyc.mvpmodelforandroid.App;
...
import com.module.wyc.mvpmodelforandroid.view.impl.UserRepoActivity;
...
public class RepoListAdapter extends RecyclerView.Adapter<RepoListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (FavoReposHelper.getInstance() == null) {
            Log.e("RepoListAdapter", "FavoReposHelper.getInstance()为空");
        }
        if (FavoReposHelper.getInstance().contains(repo)) {
            holder.starImage.setImageResource(R.mipmap.ic_star_checked);
        } else {
            holder.starImage.setImageResource(R.mipmap.ic_star_unchecked);
        }
            ...
            switch (v.getId()) {
                ...
                case R.id.star:
                    ...
                    if (FavoReposHelper.getInstance().contains(repo)) {
                        ...
                        starImage.setImageResource(R.mipmap.ic_star_unchecked);
                    } else {
                        FavoReposHelper.getInstance().addFavo(repo);
                        starImage.setImageResource(R.mipmap.ic_star_checked);
                    }
                    break;
                case R.id.avatar1:
